...
\begin{itemize}
    ...
    \item Another option for this supervised classification problem could be to apply a robust logistic regression: \text{https://rss.onlinelibrary.wiley.com/doi/10.1111/j.2517-6161.1993.tb01934.x}
...
\begin{itemize}
    ...
    \item \text{https://www.diva-portal.org/smash/get/diva2:1431621/FULLTEXT02.pdf}
\end{itemize}
