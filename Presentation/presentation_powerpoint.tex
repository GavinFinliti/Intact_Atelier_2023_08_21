...
\begin{itemize}
    ...
    \item Another option for this supervised classification problem to attempt to improve on this limitation could be to apply a robust logistic regression.
...
\begin{itemize}
    ...
    \item https://www.diva-portal.org/smash/get/diva2:1431621/FULLTEXT02.pdf
\end{itemize}
